...
# Main training loop with both improvements
acc_list = []
label_counts = []
...
for round in range(num_rounds):
    ...
    # Using both improvements: progressive image generation and adaptive sampling
...
# Save real
vutils.save_image(xU_batch[:25], f"{round_folder}/new3_sampled_real_round{round+1}.png", nrow=5, normalize=True)

# Save generated
z = g1(xU_batch[:25].to(DEVICE))
xg = g2(z)
vutils.save_image(xg, f"{round_folder}/new3_sampled_generated_round{round+1}.png", nrow=5, normalize=True)
